...
export const getSourceLocal = async (weekOf) => {
  ...
  if (typeof source.mwb_ayf_part1_type === 'object') {
    if (source.mwb_ayf_part1_type[lang] && source.mwb_ayf_part1_type[lang] !== '')
      obj.mwb_ayf_part1_type = +source.mwb_ayf_part1_type[lang];
  }
  if (source.mwb_ayf_part1_type && typeof source.mwb_ayf_part1_type !== 'object') {
    obj.mwb_ayf_part1_type = +source.mwb_ayf_part1_type;
  }
  ...
  if (typeof source.mwb_ayf_part2_type === 'object') {
    if (source.mwb_ayf_part2_type[lang] && source.mwb_ayf_part2_type[lang] !== '')
      obj.mwb_ayf_part2_type = +source.mwb_ayf_part2_type[lang];
  }
  if (source.mwb_ayf_part2_type && typeof source.mwb_ayf_part2_type !== 'object') {
    obj.mwb_ayf_part2_type = +source.mwb_ayf_part2_type;
  }
  ...
  if (typeof source.mwb_ayf_part3_type === 'object') {
    if (source.mwb_ayf_part3_type[lang] && source.mwb_ayf_part3_type[lang] !== '')
      obj.mwb_ayf_part3_type = +source.mwb_ayf_part3_type[lang];
  }
  if (source.mwb_ayf_part3_type && typeof source.mwb_ayf_part3_type !== 'object') {
    obj.mwb_ayf_part3_type = +source.mwb_ayf_part3_type;
  }
  ...
  if (typeof source.mwb_ayf_part4_type === 'object') {
    if (source.mwb_ayf_part4_type[lang] && source.mwb_ayf_part4_type[lang] !== '')
      obj.mwb_ayf_part4_type = +source.mwb_ayf_part4_type[lang];
  }
  if (source.mwb_ayf_part4_type && typeof source.mwb_ayf_part4_type !== 'object') {
    obj.mwb_ayf_part4_type = +source.mwb_ayf_part4_type;
  }
