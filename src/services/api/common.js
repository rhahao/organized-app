...
import { apiHostState, appLangState, congIDState, isOnlineState, visitorIDState } from '@states/app';
...
export const apiDefault = async () => {
  ...
  return { apiHost, visitorID, appVersion, userUID, appLang, congID, isOnline, sourceLang };
};
