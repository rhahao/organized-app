...
appDb.version(56).stores({
  visiting_speakers: '&cong_local_uid, cong_id, cong_name, cong_number, is_sync, is_deleted, changes',
});
appDb.version(57).stores({
  visiting_speakers: '&cong_local_uid, cong_id, cong_name, cong_number, cong_speakers, is_sync, is_deleted, changes',
});
...
appDb.version(60).stores({
  visiting_speakers: '&cong_number, cong_id, cong_name, cong_speakers, is_local, is_sync, is_deleted, changes',
});
appDb.version(61).stores({
  visiting_speakers: '&cong_number, cong_id, cong_name, cong_speakers, is_local, is_deleted, changes',
});
appDb.version(62).stores({
  visiting_speakers: '&cong_number, cong_id, cong_name, cong_speakers, is_local, is_pending, changes',
});
appDb.version(63).stores({
  visiting_speakers: '&cong_number, cong_id, cong_name, cong_speakers, is_local, is_pending, notif_dismissed, changes',
});
