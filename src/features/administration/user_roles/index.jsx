...
const styles = { checkbox: { paddingTop: '0 !important' } };

const CongregationUserRoles = ({
  member,
  handleCheckAdmin,
  ...
  const { disableViewMeetingRole } = useUserRoles({ member, handleCheckViewMeetingSchedule });
...
CongregationUserRoles.propTypes = {
  member: PropTypes.object,
  handleCheckAdmin: PropTypes.func,
  handleCheckSecretary: PropTypes.func,
  handleCheckLMMO: PropTypes.func,
  handleCheckLMMOAssistant: PropTypes.func,
  handleCheckViewMeetingSchedule: PropTypes.func,
  handleCheckPublicTalkCoordinator: PropTypes.func,
  handleCheckCoordinator: PropTypes.func,
};

export default CongregationUserRoles;
