...
const CongregationUserPocketSetup = ({ member, handleDeleteOCode, handleGenerateOCode }) => {
...
CongregationUserPocketSetup.propTypes = {
  member: PropTypes.object,
  handleDeleteOCode: PropTypes.func,
  handleGenerateOCode: PropTypes.func,
};

export default CongregationUserPocketSetup;
