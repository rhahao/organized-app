...
const TermsUse = () => {
  ...
  const { themeOptions, handleTermsUse, handleReturnChooser, readComplete, setReadComplete } = useTermsUse();
  ...
  return (
    <Container sx={{ padding: '15px' }}>
      ...
      >
        <Button color="inherit" variant="contained" onClick={handleReturnChooser}>
          {t('back')}
        </Button>
