...
import PersonAppointment from '../appointment';
...
PersonSpiritualStatus.propTypes = {
  isBaptized: PropTypes.bool,
  setIsBaptized: PropTypes.func,
  immersedDate: PropTypes.any,
  setImmersedDate: PropTypes.func,
  isOtherSheep: PropTypes.bool,
