...
const PersonBasic = ({
  ...
  const {
    ...
    secretaryRole,
  } = useBasic({ setName, setDisplayName, setIsMale, setIsFemale, birthDate });
...
PersonBasic.propTypes = {
  ...
  setIsMale: PropTypes.func,
  setIsFemale: PropTypes.func,
  setName: PropTypes.func,
  setDisplayName: PropTypes.func,
  birthDate: PropTypes.any,
  setBirthDate: PropTypes.func,
  personEmail: PropTypes.string,
  setPersonEmail: PropTypes.func,
  personAddress: PropTypes.string,
  setPersonAddress: PropTypes.func,
  personPhone: PropTypes.string,
  setPersonPhone: PropTypes.func,
  isPersonEditor: PropTypes.bool,
};
